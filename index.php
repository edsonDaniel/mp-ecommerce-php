                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/samsung-galaxy-s9-xxl.jpg">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/l6g6.jpg">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/u_10168742.jpg">
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/motorola-moto-g5-plus-1.jpg">
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/motorola-moto-g4-3.jpg">
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="https://edsonperez-mp-commerce-php.herokuapp.com/assets/003.jpg">
